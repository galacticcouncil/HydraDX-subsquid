...
export class Initial1629024372852 implements MigrationInterface {
    name = 'Initial1629024372852'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pool" ADD CONSTRAINT "FK_2c993f8e46c22c0d8450f40e4bf" FOREIGN KEY ("created_by_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pool" DROP CONSTRAINT "FK_2c993f8e46c22c0d8450f40e4bf"`);
