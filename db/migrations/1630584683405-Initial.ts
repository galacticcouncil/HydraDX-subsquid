...
export class Initial1630584683405 implements MigrationInterface {
    name = 'Initial1630584683405'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trade_transfer" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" character varying NOT NULL, "updated_at" TIMESTAMP DEFAULT now(), "updated_by_id" character varying, "deleted_at" TIMESTAMP, "deleted_by_id" character varying, "version" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "block" character varying NOT NULL, "parent_swap_action_id" character varying NOT NULL, "asset_sent_id" character varying NOT NULL, "asset_received_id" character varying NOT NULL, "account_sent_id" character varying NOT NULL, "account_received_id" character varying NOT NULL, "amount_sent" numeric, "amount_received" numeric, CONSTRAINT "PK_b1a0e68bf0289007b1ab421a88f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "swap_action" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" character varying NOT NULL, "updated_at" TIMESTAMP DEFAULT now(), "updated_by_id" character varying, "deleted_at" TIMESTAMP, "deleted_by_id" character varying, "version" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL, "block" character varying NOT NULL, "initiated_by_account_id" character varying NOT NULL, "intention_type" character varying NOT NULL, "amount" numeric, "token_zero_id" character varying, "token_one_id" character varying, "assets_pair" character varying, "slippage" numeric, "fees" jsonb NOT NULL, "total_fee_final" numeric, "match" numeric, "total_direct_trade_exchanged" numeric, "saved" numeric, "amount_xyk_trade" numeric, "amount_out_xyk_trade" numeric, "amount_sold_bought" numeric, "total_amount_final" numeric, "xyk_trade_pool_id" character varying, "action_metadata" jsonb, CONSTRAINT "PK_b0a467555966225698cb6ec7d8b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "trade_transfer" ADD CONSTRAINT "FK_05735f58541469940ab49215ad5" FOREIGN KEY ("parent_swap_action_id") REFERENCES "swap_action"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trade_transfer" ADD CONSTRAINT "FK_30f9e71abab62cf925beb608085" FOREIGN KEY ("asset_sent_id") REFERENCES "token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trade_transfer" ADD CONSTRAINT "FK_edafcf9ad25be627275dced7d57" FOREIGN KEY ("asset_received_id") REFERENCES "token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "trade_transfer" DROP CONSTRAINT "FK_edafcf9ad25be627275dced7d57"`);
        await queryRunner.query(`ALTER TABLE "trade_transfer" DROP CONSTRAINT "FK_30f9e71abab62cf925beb608085"`);
        await queryRunner.query(`ALTER TABLE "trade_transfer" DROP CONSTRAINT "FK_05735f58541469940ab49215ad5"`);
